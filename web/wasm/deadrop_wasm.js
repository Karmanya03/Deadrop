 ...
 * @returns {Uint8Array}
 */
export function decrypt_blob(encrypted_data, key_base64) {
    ...
    const ret = wasm.decrypt_blob(ptr0, len0, ptr1, len1);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function decrypt_chunk(encrypted_chunk, key_base64, nonce_bytes, chunk_index) {
    ...
    const ret = wasm.decrypt_chunk(ptr0, len0, ptr1, len1, ptr2, len2, chunk_index);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('deadrop_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
